  ...
  return (
    <>
      ...
      <Card className="w-full max-w-md shadow-xl">
        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button type="submit" className="w-full" data-testid="login-btn">
              {t('login_continue_with_password_button')}
            </Button>
          </form>

          <div className="text-sm text-center space-y-1">
            <Link href="/forgot-password" passHref legacyBehavior>
              <a className="font-medium text-primary hover:underline" data-testid="forgot-password-link">
                {t('login_forgot_password_link')}
              </a>
            </Link>
            <p>
              <Link href="/signup" passHref legacyBehavior>
                <a className="font-medium text-primary hover:underline" data-testid="signup-link">
      ...
      <p className="mt-8 px-8 text-center text-xs text-muted-foreground max-w-md">
        <Trans i18nKey="login_terms_notice" ns="common" values={{ appName: t('appName') }} />
      </p>
    </>
  );
}
