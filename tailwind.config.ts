    ...
    extend: {
      ...
      keyframes: {
        ...
        'fade-out-and-collapse': {
          '0%': { opacity: '1', maxHeight: '500px', transform: 'scaleY(1)', marginBottom: '0.75rem', paddingTop: '0.75rem', paddingBottom: '0.75rem' },
          '100%': { opacity: '0', maxHeight: '0px', transform: 'scaleY(0)', marginBottom: '0', paddingTop: '0', paddingBottom: '0', borderLeftWidth: '0' },
        }
      },
      animation: {
        ...
        'fade-out-and-collapse': 'fade-out-and-collapse 0.3s ease-in-out forwards',
      },
